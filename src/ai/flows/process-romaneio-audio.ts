...
const extractionPrompt = ai.definePrompt({
    ...
    *   Comandos como "corrigir", "somente", "apenas" servem para focar em um item específico, mas a lógica de retorno deve ser a mesma de uma adição normal. A IA apenas retorna o item modificado.
    ...
    *   Exemplo 3: "Ovos, 2 dúzias. Fornecedor Onéias" deve resultar em { product: 'Ovos Orgânicos', quantity: '2 dz', fornecedor: 'Onéias' }.
    ...
    Por padrão, o campo 'clearAll' deve ser 'false' a menos que a regra 1 seja acionada.
