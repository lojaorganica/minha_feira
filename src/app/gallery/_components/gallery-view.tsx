    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-4">
                ...
                >
                    <Heart className={cn(
                        "h-7 w-7 transition-colors hover-hover:group-hover:fill-destructive hover-hover:group-hover:stroke-destructive",
                        isShowingFavorites
            ...
            <div className="sticky top-16 lg:top-[124px] bg-background/95 backdrop-blur-sm z-10 py-4 space-y-2">
